...
std::vector<SupportedOp> supported_op_mode = {
    ...
    {"Expand", V_2023_0, {"VPUX"}},
    {"EyeLike", V_2022_1, {"CPU"}},
    {"EyeLike", V_2023_0, {"VPUX"}},
    ...
    {"GlobalLpPool", V_2023_0, {"VPUX"}},
    {"GlobalMaxPool", V_2022_1, {"CPU", "GPU"}},
    {"GlobalMaxPool", V_2023_0, {"VPUX"}},
