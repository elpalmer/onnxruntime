...
typedef struct OrtOpenVINOProviderOptions {
  ...
  OrtOpenVINOProviderOptions() : device_type{}, enable_vpu_fast_compile{}, device_id{},
                                 num_of_threads{}, cache_dir{}, num_streams{},
  ...
  size_t num_streams;        ///< 1 = default, -1 = ov::streams::AUTO (let device decide), >1 = user defined number of parallel inference streams
  void* context;
